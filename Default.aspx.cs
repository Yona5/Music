    ...
    public partial class _Default : System.Web.UI.Page
    {
        ...
        protected void submitButton_Click(object sender, EventArgs e)
        {
            if (upload.HasFile)
            {
                ...
                String title = upload.FileName.Replace(".mp3", "");
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            try
            {
                ...
                MusicDisplayControl.DataSource = from o in getMusicGalleryContainer().GetDirectoryReference("samples").ListBlobs()
                                                     select new { Url = o.Uri, Title = setTitle(o.Uri)};

                // Tell the list view to bind to its data source, thereby
                // showing 
                MusicDisplayControl.DataBind();
            }
            catch (Exception)
            {
            }
        ...
        protected String setTitle(Uri uri) {
            String title = "";
            try{
